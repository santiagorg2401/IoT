...
host: 'localhost',
user: 'root',
password: 'xxxx', //el password de ingreso a mysql
database: 'CaliDatos',
port: 3306});
...
router.get('/datos', (req,res) => {
    ...
    json1={"idnodo":resultado[i].idnodo, "temperatura":resultado[i].temperatura,
...
router.post('/datos', (req,res) => {
    ...
    console.log('Conexion correcta.');
    tempConn.query('INSERT INTO datosNodo VALUES(null, ?, ?,?,?)', [json1.idnodo, json1.temperatura,
